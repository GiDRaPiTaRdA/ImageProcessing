...
namespace ImageProcessing.MagicWand.Magic
{
    ...
    public abstract class AbstractFloodFiller : object
    {
        ...
        public Color FillColor
        {
            get
            {
                return this.m_fillcolorcolor;
            }
            set
            {
                this.m_fillcolorcolor = value;
            }
        }
        ...
        public bool FillDiagonal
        {
            get
            {
                return this.m_FillDiagonal;
            }
            set
            {
                this.m_FillDiagonal = value;
            }
        }
        ...
        public void FloodFill()
        {
            ...
            try
            {
                this.FloodFill(this.m_Bmp, this.m_Pt);
            }
            catch (Exception e)
            {
                ex = e;
                this.OnFillFinished(new FillFinishedEventArgs(ex));
                return;
        ...
        {
            if (this.FillFinished != null)
                this.FillFinished.BeginInvoke(this, args, null, null);
        }
